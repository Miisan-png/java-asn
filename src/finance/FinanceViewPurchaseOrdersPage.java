...
public class FinanceViewPurchaseOrdersPage extends UIBase {
    ...
    public FinanceViewPurchaseOrdersPage(User user) {
    ...
    private JPanel createSidebar() {
        ...
        logoutBtn.addActionListener(e -> {
            int response = JOptionPane.showConfirmDialog(FinanceViewPurchaseOrdersPage.this,
    ...
    private void goBackToDashboard() {
        dispose();
        SwingUtilities.invokeLater(() -> {
            FinanceDashboardPage dashboard = new FinanceDashboardPage(currentUser);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            FinanceViewPurchaseOrdersPage ordersPage = new FinanceViewPurchaseOrdersPage(testUser);
