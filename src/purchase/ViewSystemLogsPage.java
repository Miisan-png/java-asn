...
public class ViewSystemLogsPage extends UIBase {
    ...
    public ViewSystemLogsPage(User user) {
    ...
    private JPanel createSidebar() {
        ...
        JPanel logsItem = createMenuItem("View PM System Logs", true);
